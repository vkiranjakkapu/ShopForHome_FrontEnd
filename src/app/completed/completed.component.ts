...
export class CompletedComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // this.completedBooks = this._authService.getCurrentUser()?.getCompleted()?.map((bid)=>{return this._bookService.getBookById(bid)});
